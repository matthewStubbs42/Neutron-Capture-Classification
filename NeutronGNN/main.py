#models
from models import GCN, AGNN, SG, GAT
...
def run(args):
    ...
    model = Train(model_type, iteration_display=args.print_interval, log_number=args.logNumber, val_number=args.valNumber, train_loader=trainDL, val_loader=valDL, 
                  num_epochs=config.epochs, learning_rate=config.lr, dump_path=config.dump_path)
