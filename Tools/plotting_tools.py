...
def disp_learn_hist_smoothed(location, window_train, window_val, model, gnn=False, fc=False, dw=False, k=False, losslim=None, show=False):
...
def ROC(location, model, gnn=False, fc=False, dw=False, k=False, title=None):
